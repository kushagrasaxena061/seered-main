            ...
            <div className="pb-6 sm:pb-8 lg:pb-12">
                <header className="text-gray-600 body-font">
                    <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                        ...
                        <button className="hidden md:inline items-center  bg-red-600 border-0 p-4 focus:outline-none hover:bg-red-500 rounded-lg text-sm text-white font-bold mt-4 md:mt-0">Log In
                        </button>
