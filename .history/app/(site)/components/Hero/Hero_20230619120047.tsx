            ...
            <div className="pb-6 sm:pb-8 lg:pb-12">
                <header className="text-gray-600 body-font">
                    <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                        ...
                        <button className="inline-flex items-center bg-gray-100 border-0 p-3 focus:outline-none hover:bg-gray-200 rounded-lg text-sm text-black font-bold mt-4 md:mt-0">Log In
                        </button>
                    </div>
                </header>
