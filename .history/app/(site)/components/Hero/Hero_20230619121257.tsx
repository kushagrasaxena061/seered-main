                ...
                <header className="text-gray-600 body-font">
                    <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                        ...
                        <nav className="md:ml-auto md:flex flex-wrap items-center text-base justify-center">
                            <Link href="/about">
                            <div className="mr-5 md:inline hidden hover:bg-red-600 hover:text-white p-3 rounded-lg text-red-500 text-sm font-bold">About</div>
                            </Link>
                            <Link href="/contact">
                            <div className="mr-5 md:inline hidden hover:bg-red-600 hover:text-white p-3 rounded-lg text-red-500 text-sm font-bold">Contact</div>
                            </Link>
                        </nav>
                        <button className="inline-flex items-center  bg-red-600 border-0 p-4 focus:outline-none hover:bg-red-500 rounded-lg text-sm text-white font-bold mt-4 md:mt-0">Log In
                        </button>
