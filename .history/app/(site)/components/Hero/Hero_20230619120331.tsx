                ...
                <header className="text-gray-600 body-font">
                    <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                        ...
                        <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
                            <Link href="/about">
                            <div className="mr-5 hover:text-gray-900 text-red-600 text-sm font-bold">About</div>
                            </Link>
                            <Link href="/contact">
                            <div className="mr-5 hover:text-gray-900 text-red-600 text-sm font-bold">Contact</div>
                            </Link>
                        </nav>
