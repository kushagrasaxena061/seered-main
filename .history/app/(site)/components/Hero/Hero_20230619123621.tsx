                ...
                <section className="mx-auto max-w-screen-2xl px-4 md:px-8 mt-3">
                    <div className="mb-8 flex flex-wrap justify-between md:mb-16">
                        <div className="mb-6 flex w-full flex-col justify-center sm:mb-12 lg:mb-0 lg:w-1/3 lg:pt-48 lg:pb-24">
                            ...
                            <button onClick={() => router.push('/auth')} className="hidden md:inline items-center  bg-red-600 border-0 p-4 focus:outline-none hover:bg-red-500 rounded-lg text-sm text-white font-bold mt-8 md:mt-0">Log In
                        </button>
                        </div>
