            ...
            <div className="pb-6 sm:pb-8 lg:pb-12">
                <header className="mb-8 ">
                    <div className="mx-auto flex max-w-screen-2xl items-center justify-between px-4 md:px-8">
                        ...
                        <div className="flex">
                            <a href="#" className="h-12 rounded-lg w-12 flex-col items-center justify-center gap-1.5 transition duration-100 hover:bg-gray-100 active:bg-gray-200 sm:flex sm:h-20 sm:w-20 md:h-24 md:w-24">
                                <span className="hidden md:inline text-xs font-semibold text-gray-500 sm:block">About</span>
                            </a>
                            <a href="#" className="flex rounded-lg h-12 w-12 flex-col items-center justify-center gap-1.5 transition duration-100 hover:bg-gray-100 active:bg-gray-200 sm:h-20 sm:w-20 md:h-24 md:w-24">
                                <span className="hidden md:inline text-xl font-semibold text-gray-500 sm:block">Account</span>
                            </a>
                            <button type="button" className="rounded-lg flex h-12 w-12 flex-col items-center justify-center gap-1.5 transition duration-100 hover:bg-gray-100 active:bg-gray-200 sm:h-20 sm:w-20 md:h-24 md:w-24 sm:hidden">
