                ...
                <section className="mx-auto max-w-screen-2xl px-4 md:px-8 mt-3">
                    <div className="mb-8 flex flex-wrap justify-between md:mb-16">
                        <div className="mb-6 flex w-full flex-col justify-center sm:mb-12 lg:mb-0 lg:w-1/3 lg:pt-48 lg:pb-24">
                            <h1 className="text-black-800 mb-4 text-4xl font-bold sm:text-5xl md:mb-8 md:text-6xl">Where Melodies Collide,<br />NFTs Reside</h1>
                            <p className="max-w-md leading-relaxed text-gray-500 xl:text-lg">Embark on a musical journey like never before. Explore, buy, sell, and trade NFTs while enjoying your favorite tunes.</p>
                        </div>
