                ...
                <header className="mb-8 ">
                    <div className="mx-auto flex max-w-screen-2xl items-center justify-between px-4 md:px-8">
                        ...
                        <div className="flex space-x-6">
                            ...
                            <a href="#" className="flex rounded-lg h-8 w-8 flex-col items-center justify-center gap-1.5 transition duration-100 bg-gray-100 active:bg-gray-200 sm:h-20 sm:w-20 md:h-24 md:w-24">
