                ...
                <header className="mb-8 ">
                    <div className="mx-auto flex max-w-screen-2xl items-center justify-between px-4 md:px-8">
                        ...
                        <div className="flex divide-x">
                            ...
                            <a href="#" className="flex h-12 w-12 flex-col items-center justify-center transition duration-100 hover:bg-gray-100 active:bg-gray-200 sm:h-20 sm:w-20 md:h-24 md:w-24">
