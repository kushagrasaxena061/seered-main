            ...
            <div className="pb-6 sm:pb-8 lg:pb-12 bg-teal-950">
                <header className="text-gray-600 body-font bg-black">
                    <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                        ...
                        <button onClick={() => router.push('/auth')} className="hidden md:inline items-center border-0 p-4 focus:outline-none  rounded-lg text-sm font-bold mt-4 md:mt-0 button bg-gradient-to-r from-cyan-400 to-red-500 hover:from-pink-500 hover:to-yellow-500 text-black hover:text-white">Log In
                        </button>
                    </div>
                </header>
                <section className="mx-auto max-w-screen-2xl px-4 md:px-8 bg-gradient-to-b from-black from-10% via-zinc-900 via-30% to-teal-950 to-90%">
                    <div className="flex flex-wrap justify-between">
                        <div className="mb-6 flex w-full flex-col justify-center sm:mb-12 lg:mb-0 lg:w-1/3 lg:pt-48 lg:pb-24">
                            ...
                            <button onClick={() => router.push('/auth')} className="md:hidden items-center border-0 p-4 focus:outline-none  rounded-lg text-sm font-bold mt-4 md:mt-0 button bg-gradient-to-r from-cyan-400 to-red-500 hover:from-pink-500 hover:to-yellow-500 text-black hover:text-white">Sign Up
                            </button>
                        </div>
